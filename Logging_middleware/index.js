...
class Logger {
  constructor() {
    ...
    // Setup online/offline listeners if in browser environment
   ...
   * @param {string} package - Valid package name based on stack
  ...
  async Log(stack, level, packageName, message) {
    try {
      ...
      // This is our fallback - we don't use console.log as per requirements
